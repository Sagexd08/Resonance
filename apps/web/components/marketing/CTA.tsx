        ...
        <section className="py-32 px-4 relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto relative z-10 text-center">
                ...
                >
                    <Link
                        href="/signup"
                        className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 rounded-2xl bg-white text-black font-bold text-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_-10px_rgba(255,255,255,0.5)]"
                    >
